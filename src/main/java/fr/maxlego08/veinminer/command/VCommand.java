package fr.maxlego08.veinminer.command;
...
import fr.maxlego08.veinminer.utils.commands.Arguments;
import fr.maxlego08.veinminer.utils.commands.CollectionBiConsumer;
import fr.maxlego08.veinminer.utils.commands.CommandType;
import fr.maxlego08.veinminer.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
    ...
    protected final VeinMinerPlugin plugin;
    /**
     ...
     */
    public VCommand(VeinMinerPlugin plugin) {
        super();
        this.plugin = plugin;
    }
     ...
     */
    public CommandType prePerform(VeinMinerPlugin plugin, CommandSender commandSender, String[] args) {
     ...
     * @return the command type.
     */
    protected abstract CommandType perform(VeinMinerPlugin plugin);
     ...
     */
    public List<String> toTab(VeinMinerPlugin plugin, CommandSender sender, String[] args) {
